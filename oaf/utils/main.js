...
var ImageOptions = {
	...
	Repeate : 1   ,		// to specify a different nb of image betwen L and RGB , if only a value is set all the LRG will take the same 
	ExposureTime : 5,
	Filter : 3,				
	ObjectName : "M57",
//	Binning : 2,
...
async.series([ 
	...
	// close all
	function(callback) {closaAll(Common);callback(null)}
	],
	function(err,result){
	if (err)
		Error(err);
